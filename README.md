# desafio-javascript-dio-contagem-cedulas
Algoritmo usado para resolução do exercício "Contagem de Cédulas" em JavaScript no curso da DIO.

Link do Exercício: [Contagem de Cédulas](https://web.digitalinnovation.one/coding/fundamentos-aritmeticos-em-javascript/algorithm/contagem-de-cedulas?back=/track/html-web-developer)
